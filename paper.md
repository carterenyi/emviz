...
# Acknowledgements
We acknowledge contributions from William Dula who is currently working on translating the algorithm and visualization scripts to Python for the ATAVizM project. The project was partially funded by the American Council of Learned Societies (ACLS).
